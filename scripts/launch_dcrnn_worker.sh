#!/usr/bin/env bash
# Startet EINEN DCRNN-HPO-Worker in der laufenden Shell (fuer `screen -dmS`).
#
...
#
#   scripts/launch_dcrnn_worker.sh <REPO> <CONFIG> <GPU> <SUFFIX>
#
# Beispiel:
#   screen -dmS hpo_dcrnn_nwp_r2 bash scripts/launch_dcrnn_worker.sh \
#       "$PWD" configs/dcrnn/config_wind_dcrnn.yaml 1 r2
