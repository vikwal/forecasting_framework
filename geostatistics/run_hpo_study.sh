...
SESSIONS=(
    ...
    #"0  hpo_dcrnn_nwp_hist geostatistics/hpo_dcrnn.py    configs/dcrnn/config_wind_dcrnn_nwp_hist_new.yaml"
    "1  hpo_dcrnn_nwp_hist geostatistics/hpo_dcrnn.py    configs/dcrnn/config_wind_dcrnn_nwp_hist_new.yaml"
    "2  hpo_mtgnn_nwp_hist geostatistics/hpo_mtgnn.py    configs/mtgnn/config_wind_mtgnn_nwp_hist_new.yaml"
    #"3  hpo_mtgnn_nwp_hist geostatistics/hpo_mtgnn.py    configs/mtgnn/config_wind_mtgnn_nwp_hist_new.yaml"
)
