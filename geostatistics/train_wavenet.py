...
def main() -> None:
    ...
    if args.hpo_study:
        ...
        study_name = f"cl_m-wavenet_out-{F_h_tmp}_freq-{freq_tmp}_{hpo_stem}"
        ...
        if storage_url:
            ...
            db_path = (
                ...
                else f"studies/hpo_wavenet_{hpo_stem}.db"
            )
        ...
        logger.info("Overriding wavenet cfg with HPO best params:")
    ...
    if _ecmwf_nan_arrays:
        ...
        val_run_pairs = exclude_run_pairs_with_ecmwf_nan(
            val_run_pairs, _ecmwf_nan_arrays, run_times, H, F_h,
        )
