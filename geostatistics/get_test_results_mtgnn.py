...
def main() -> None:
    ...
    # ── Temporal split ───────────────────────────────────────────────────────
    # Mirrors train_mtgnn.py's val_start/test_start boundary (review brief H2):
    # without this, a dev-mode eval on a spatial-CV fold model silently scores
    # against the held-out test period, because test_start was the only
    # boundary this script knew about.
